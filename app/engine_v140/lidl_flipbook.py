...
def capture_lidl_flipbook(
    ...
    *,
    ...
    diagnostics = (
        ...
        f"price_anchors_detected={pdf_extraction.price_anchors_detected} "
        f"price_anchors_matched={pdf_extraction.price_anchors_matched} "
        f"price_anchors_ignored={pdf_extraction.price_anchors_ignored} "
        f"price_anchors_unmatched={pdf_extraction.price_anchors_unmatched} "
        f"price_anchor_match_rate={pdf_extraction.price_anchor_match_rate:.1f} "
        f"page_offer_recall={pdf_extraction.page_offer_recall:.1f} "
        f"pages_with_unmatched_prices={','.join(map(str, pdf_extraction.pages_with_unmatched_prices)) or '-'} "
