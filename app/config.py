...
class Settings:
    ...
    collector_collapse_history_runs: int = int(os.getenv("COLLECTOR_COLLAPSE_HISTORY_RUNS", "5"))
    collector_collapse_minimum_history: int = int(os.getenv("COLLECTOR_COLLAPSE_MINIMUM_HISTORY", "3"))
    collector_collapse_warning_ratio: float = float(os.getenv("COLLECTOR_COLLAPSE_WARNING_RATIO", "0.70"))
    collector_collapse_block_ratio: float = float(os.getenv("COLLECTOR_COLLAPSE_BLOCK_RATIO", "0.40"))
