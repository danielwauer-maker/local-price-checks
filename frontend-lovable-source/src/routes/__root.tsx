...
import { PricingFeedbackBadge } from "@/components/PricingFeedbackBadge";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mobile WebApp zum Vergleich von Supermärkten im Umkreis: beste Angebote finden und optimale Einkaufsliste erstellen." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Outfit:wght@500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <AppStoreProvider>
        <UsageTracker />
        {!bare && <FirstStartOnboarding />}
        {!bare && <PricingFeedbackBadge />}
