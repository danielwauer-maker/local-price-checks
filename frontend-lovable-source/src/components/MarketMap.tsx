...
function markerIcon(label: string, active: boolean, chosen: boolean) {
  return L.divIcon({
    className: "",
    html: `<div style="
      ...
      background:${chosen ? "oklch(0.47 0.113 158)" : "#fff"};
      border:2px solid ${chosen ? "oklch(0.86 0.17 105)" : "oklch(0.9 0.01 130)"};
  ...
  return (
    ...
    >
      ...
      <Circle
        ...
        pathOptions={{
          color: "oklch(0.47 0.113 158)",
          weight: 1.5,
          fillColor: "oklch(0.47 0.113 158)",
          fillOpacity: 0.07,
        }}
      />
      ...
      {markets.map((m) => (
        <Marker
          ...
          icon={markerIcon(m.chain.split(" ")[0]!, activeId === m.id, selected.includes(m.id))}
