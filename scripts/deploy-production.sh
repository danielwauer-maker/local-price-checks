...
# Compose changes may affect both build definitions and runtime wiring.
...
# If only docs/workflow/scripts changed, source still advances but containers stay untouched.
